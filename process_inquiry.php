...
");
  ...
  $_SESSION['error'] = "Something went wrong. Please try again."; // Show user error message
...
$admin_emails = [];
$stmt = $conn->prepare("SELECT email FROM employees WHERE role = 'admin' AND status = 'active'");
$stmt->execute();
$result = $stmt->get_result();

// Collect all active admin emails
      ...
      <tr>
        <td align="center">
          <table width="600" cellpadding="0" cellspacing="0"
            ...
            <!-- Header -->
            <tr>
              <td style="padding:36px 40px 28px;text-align:center;border-bottom:2px solid rgba(217,255,0,0.25);">
                  ...
                  <tr>
                    <td style="padding:20px 24px;">
                      ...
                      <table width="100%" cellpadding="7" cellspacing="0">
                        <tr>
                          <td style="color:rgba(255,255,255,0.65);font-size:13px;width:140px;">Reference #</td>
                          <td style="color:#fff;font-size:13px;font-weight:700;font-family:monospace;">{$inquiry_number}</td>
                        </tr>
                        <tr>
                          <td style="color:rgba(255,255,255,0.65);font-size:13px;">Service</td>
                          <td style="color:#fff;font-size:13px;">{$service_name}</td>
                        </tr>
                        <tr>
                          <td style="color:rgba(255,255,255,0.65);font-size:13px;">Processing Type</td>
                        ...
                        <tr>
                          <td style="color:rgba(255,255,255,0.65);font-size:13px;">Est. Timeline</td>
                          <td style="color:#fff;font-size:13px;">{$proc_timeline}</td>
                        </tr>
                        <tr>
                          <td style="color:rgba(255,255,255,0.65);font-size:13px;">Estimated Fee</td>
                          <td style="color:#D9FF00;font-size:14px;font-weight:700;">{$price_display}</td>
                        </tr>
                        <tr>
                          <td style="color:rgba(255,255,255,0.65);font-size:13px;">Date Submitted</td>
                          <td style="color:#fff;font-size:13px;">{$submitted_at}</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
            ...
            <!-- Security Notice -->
            <tr>
              <td style="padding:18px 40px;background:rgba(0,0,0,0.18);border-top:1px solid rgba(255,255,255,0.08);">
            ...
            <tr>
              <td style="padding:24px 40px;background:#0B2B2E;text-align:center;">
                <p style="color:rgba(255,255,255,0.5);font-size:12px;margin:0;">
                  This is an automated message from <strong style="color:#D9FF00;">{$company_name}</strong>.<br>
        ...
        <tr>
          <td align="center">
            <table width="580" cellpadding="0" cellspacing="0"
              ...
              <!-- Header -->
              <tr>
                <td style="background:linear-gradient(135deg,#0F3A40,#1C4F50);padding:28px 36px;text-align:center;">
